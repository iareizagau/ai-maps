...
class DanceVenueClaimForm(forms.ModelForm):
    class Meta:
        ...
        help_texts = {
            "evidence": _(
                "Tell us your role at the venue and any details that help us verify ownership."
            ),
        }
...
class DanceVenueManageForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "styles": forms.Textarea(
                attrs={"rows": 2, "placeholder": '["salsa", "bachata", "kizomba"]'}
            ),
            "weekly_schedule": forms.Textarea(
                attrs={
                    "rows": 4,
                    "placeholder": '{"mon": {"class": ["bachata-19h"]}, "wed": {"social": ["21h-2h"]}}',
                }
            ),
        }
