...
ICE_VEHICLES = [
    ...
    },
    {
        ...
        "year": 2025,
        "propulsion": Vehicle.Propulsion.ICE,
        "consumption_l_100km": Decimal("5.4"),
        "price_eur": 13_900,
    },
    {
        "make": "Renault",
        ...
        "year": 2025,
        "propulsion": Vehicle.Propulsion.ICE,
        "consumption_l_100km": Decimal("5.9"),
        "price_eur": 22_300,
    },
    {
        "make": "Peugeot",
        ...
        "year": 2025,
        "propulsion": Vehicle.Propulsion.ICE,
        "consumption_l_100km": Decimal("5.2"),
        "price_eur": 20_500,
    },
    {
        "make": "Citroën",
        "model": "C3 PureTech 83",
        "year": 2025,
        "propulsion": Vehicle.Propulsion.ICE,
        "consumption_l_100km": Decimal("5.5"),
        "price_eur": 17_900,
    },
    {
        "make": "Hyundai",
        ...
        "year": 2025,
        "propulsion": Vehicle.Propulsion.ICE,
        "consumption_l_100km": Decimal("7.2"),
        "price_eur": 30_900,
    },
    {
        "make": "Kia",
        ...
        "year": 2025,
        "propulsion": Vehicle.Propulsion.ICE,
        "consumption_l_100km": Decimal("7.0"),
        "price_eur": 29_500,
    },
    {
        "make": "Seat",
        ...
        "year": 2025,
        "propulsion": Vehicle.Propulsion.ICE,
        "consumption_l_100km": Decimal("5.7"),
        "price_eur": 22_900,
    },
    {
        "make": "Toyota",
        "model": "Yaris 1.5 VVT-i",
        "year": 2025,
        "propulsion": Vehicle.Propulsion.ICE,
        "consumption_l_100km": Decimal("5.3"),
        "price_eur": 19_800,
    },
]
...
DIESEL_VEHICLES = [
    {
        ...
        "year": 2024,
        "propulsion": Vehicle.Propulsion.DIESEL,
        "consumption_l_100km": Decimal("6.1"),
        "price_eur": 38_900,
    },
    {
        "make": "Skoda",
        ...
        "year": 2024,
        "propulsion": Vehicle.Propulsion.DIESEL,
        "consumption_l_100km": Decimal("4.7"),
        "price_eur": 28_900,
    },
    {
        "make": "Ford",
        ...
        "year": 2024,
        "propulsion": Vehicle.Propulsion.DIESEL,
        "consumption_l_100km": Decimal("4.6"),
        "price_eur": 26_500,
    },
    {
        "make": "BMW",
        ...
        "year": 2024,
        "propulsion": Vehicle.Propulsion.DIESEL,
        "consumption_l_100km": Decimal("5.0"),
        "price_eur": 48_900,
    },
    {
        "make": "Peugeot",
        "model": "3008 BlueHDi 130",
        "year": 2024,
        "propulsion": Vehicle.Propulsion.DIESEL,
        "consumption_l_100km": Decimal("5.2"),
        "price_eur": 33_500,
...
HEV_VEHICLES = [
    ...
    },
    {
        ...
        "year": 2025,
        "propulsion": Vehicle.Propulsion.HEV,
        "consumption_l_100km": Decimal("4.4"),
        "price_eur": 24_500,
    },
    {
        "make": "Toyota",
        ...
        "year": 2025,
        "propulsion": Vehicle.Propulsion.HEV,
        "consumption_l_100km": Decimal("4.8"),
        "price_eur": 32_500,
    },
    {
        "make": "Renault",
        ...
        "year": 2025,
        "propulsion": Vehicle.Propulsion.HEV,
        "consumption_l_100km": Decimal("4.3"),
        "price_eur": 22_900,
    },
    {
        "make": "Honda",
        ...
        "year": 2024,
        "propulsion": Vehicle.Propulsion.HEV,
        "consumption_l_100km": Decimal("6.4"),
        "price_eur": 42_900,
    },
    {
        "make": "Hyundai",
...
PHEV_VEHICLES = [
    {
        ...
        "battery_kwh": Decimal("19.7"),
        "range_wltp_km": 100,
        "consumption_l_100km": Decimal("1.4"),
        "consumption_kwh_100km": Decimal("19.5"),
        "price_eur": 46_900,
    },
    {
        "make": "Hyundai",
        ...
        "year": 2025,
        "propulsion": Vehicle.Propulsion.PHEV,
        "battery_kwh": Decimal("13.8"),
        "range_wltp_km": 62,
        "consumption_l_100km": Decimal("1.6"),
        "consumption_kwh_100km": Decimal("17.7"),
        "price_eur": 39_500,
    },
    {
        "make": "BMW",
        ...
        "year": 2025,
        "propulsion": Vehicle.Propulsion.PHEV,
        "battery_kwh": Decimal("19.5"),
        "range_wltp_km": 95,
        "consumption_l_100km": Decimal("1.7"),
        "consumption_kwh_100km": Decimal("18.3"),
        "price_eur": 56_900,
    },
    {
        "make": "Cupra",
        "model": "Formentor VZ e-Hybrid",
        "year": 2025,
        "propulsion": Vehicle.Propulsion.PHEV,
        "battery_kwh": Decimal("19.7"),
        "range_wltp_km": 100,
        "consumption_l_100km": Decimal("1.5"),
        "consumption_kwh_100km": Decimal("19.9"),
        "price_eur": 50_500,
    },
]
...
BEV_VEHICLES = [
    ...
    },
    {
        ...
        "year": 2025,
        "propulsion": Vehicle.Propulsion.BEV,
        "battery_kwh": Decimal("58.0"),
        "range_wltp_km": 426,
        "consumption_kwh_100km": Decimal("15.0"),
        "price_eur": 39_900,
    },
    {
        "make": "Volkswagen",
    ...
    {
        "make": "Hyundai",
        "model": "Kona Electric 65",
        "year": 2025,
        "propulsion": Vehicle.Propulsion.BEV,
        "battery_kwh": Decimal("65.4"),
        "range_wltp_km": 514,
        "consumption_kwh_100km": Decimal("14.7"),
        "price_eur": 38_900,
    },
    {
        "make": "Hyundai",
        ...
        "year": 2025,
        "propulsion": Vehicle.Propulsion.BEV,
        "battery_kwh": Decimal("77.4"),
        "range_wltp_km": 507,
        "consumption_kwh_100km": Decimal("16.7"),
        "price_eur": 45_900,
    },
    {
        "make": "Cupra",
        ...
        "battery_kwh": Decimal("58.0"),
        "range_wltp_km": 424,
        "consumption_kwh_100km": Decimal("15.5"),
        "price_eur": 38_900,
    },
    {
        "make": "Renault",
        ...
        "battery_kwh": Decimal("60.0"),
        "range_wltp_km": 470,
        "consumption_kwh_100km": Decimal("14.4"),
        "price_eur": 36_900,
    },
    {
        "make": "Peugeot",
    ...
    },
    {
        ...
        "year": 2025,
        "propulsion": Vehicle.Propulsion.BEV,
        "battery_kwh": Decimal("83.9"),
        "range_wltp_km": 590,
        "consumption_kwh_100km": Decimal("16.1"),
        "price_eur": 60_900,
    },
    {
        "make": "Mercedes-Benz",
        ...
        "year": 2025,
        "propulsion": Vehicle.Propulsion.BEV,
        "battery_kwh": Decimal("66.5"),
        "range_wltp_km": 426,
        "consumption_kwh_100km": Decimal("17.8"),
        "price_eur": 51_900,
    },
    {
        "make": "Citroën",
        ...
        "battery_kwh": Decimal("50.0"),
        "range_wltp_km": 357,
        "consumption_kwh_100km": Decimal("16.6"),
        "price_eur": 31_900,
    },
]
...
CHARGERS = [
    {
        "external_id": "demo-ocm-001",
        "source": "demo",
        "operator": "Repsol",
        "address": "Aiete, Donostia",
        "lat": 43.296,
        "lon": -1.999,
        "power_kw": Decimal("22"),
    ...
    {
        "external_id": "demo-ocm-002",
        "source": "demo",
        "operator": "Iberdrola bP",
        "address": "Plaza Pío XII, Donostia",
        "lat": 43.301,
        "lon": -1.985,
        "power_kw": Decimal("50"),
    ...
    {
        "external_id": "demo-ocm-003",
        "source": "demo",
        "operator": "Endesa X",
        "address": "Anoeta, Donostia",
        "lat": 43.302,
        "lon": -1.989,
    ...
    {
        "external_id": "demo-ocm-004",
        "source": "demo",
        "operator": "Ionity",
        "address": "AP-8 km 8 — Astigarraga",
        "lat": 43.286,
        "lon": -1.948,
    ...
    {
        "external_id": "demo-ocm-005",
        "source": "demo",
        "operator": "Wenea",
        "address": "Ondarreta parking, Donostia",
        "lat": 43.318,
        "lon": -2.025,
        "power_kw": Decimal("22"),
        "connectors": [{"type": "Type 2", "kw": 22}],
    ...
    {
        "external_id": "demo-ocm-006",
        "source": "demo",
        "operator": "Tesla Supercharger",
        "address": "Centro Comercial Garbera",
        "lat": 43.305,
        "lon": -1.973,
    ...
    def handle(self, *args, **options):
        for spec in VEHICLES:
            obj, created = Vehicle.objects.update_or_create(
                ...
                year=spec["year"],
                defaults={
                    k: v for k, v in spec.items() if k not in ("make", "model", "year")
                },
            )
