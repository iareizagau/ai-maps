...
urlpatterns = [
    ...
    path(
        "api/events/<uuid:event_id>/matchmaking/",
        views.toggle_matchmaking,
        name="toggle_matchmaking",
    ),
    path(
        "api/events/<uuid:event_id>/community/",
        views.event_community_api,
        name="event_community",
    ),
    path(
        "api/events/<uuid:event_id>/review/",
        views.submit_event_review,
        name="submit_event_review",
    ),
    ...
    path(
        "api/events/<uuid:event_id>/notice/",
        views.submit_event_notice,
        name="submit_event_notice",
    ),
    path("api/events/<uuid:event_id>/checkin/", views.check_in, name="check_in"),
    path(
        "api/events/<uuid:event_id>/vibe/",
        views.submit_vibe_report,
        name="submit_vibe_report",
    ),
    ...
    # Venue claim + manage
    path(
        "venue/<int:venue_id>/claim/", views.dance_venue_claim, name="dance_venue_claim"
    ),
    path(
        "venue/<int:venue_id>/manage/",
        views.dance_venue_manage,
        name="dance_venue_manage",
    ),
