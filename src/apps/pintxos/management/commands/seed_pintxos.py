...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        restaurants_data = [
            ...
            (
                "El Globo",
                "Referente de pintxos junto a la Gran Vía.",
                43.2631,
                -2.9348,
                Restaurant.Category.BAR,
                "Calle de la Diputación, 8, Bilbao",
            ),
            (
                "Ledesma 5",
                "Moderno y vibrante en la mítica calle Ledesma.",
                43.2625,
                -2.9312,
                Restaurant.Category.RESTAURANT,
                "Calle Ledesma, 5, Bilbao",
            ),
            (
                "Gure Toki",
                "Alta cocina en miniatura en el corazón de la Plaza Nueva.",
                43.2592,
                -2.9234,
                Restaurant.Category.BAR,
            ...
            (
                "Berton",
                "Tradición y calidad en el Casco Viejo.",
                43.2588,
                -2.9245,
                Restaurant.Category.BAR,
                "Jardin Kalea, 11, Bilbao",
            ),
            # Donostia (San Sebastián)
            (
                "La Viña",
                "Famoso mundialmente por su tarta de queso.",
                43.3242,
                -1.9839,
                Restaurant.Category.BAR,
                "Calle del Treinta y Uno de Agosto, 3, Donostia",
            ),
            (
                "Gandarias",
                "Pintxos clásicos de primera calidad.",
                43.3241,
                -1.9842,
                Restaurant.Category.RESTAURANT,
                "Calle del Treinta y Uno de Agosto, 23, Donostia",
            ),
            (
                "Bar Nestor",
                "La mejor tortilla y chuletón de la ciudad.",
                43.3238,
                -1.9845,
                Restaurant.Category.BAR,
                "Arrandegi Kalea, 11, Donostia",
            ),
            (
                "Borda Berri",
                "Pintxos calientes creativos y deliciosos.",
                43.3235,
                -1.9838,
                Restaurant.Category.BAR,
                "Fermin Calbeton Kalea, 12, Donostia",
            ),
        ]
        ...
        self.stdout.write(
            self.style.SUCCESS("Successfully seeded pintxos data and ratings!")
        )
