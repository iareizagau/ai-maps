...
from .models import PointOfInterest, Route, TrailEdge
        ...
        routes_list.append(
            {
                ...
                "geojson": json.loads(r.geom_simplified_geojson)
                if r.geom_simplified_geojson
                else {},
            }
        )
...
def explore_view(request):
    ...
    following_ids = Follow.objects.filter(
        follower=request.user, app_context="adventure"
        ...
        terrain_features.append(
            {
                ...
                "properties": {"surface": "unknown", "highway": "unknown"},
            }
        )

    terrain_geojson = {"type": "FeatureCollection", "features": terrain_features}
