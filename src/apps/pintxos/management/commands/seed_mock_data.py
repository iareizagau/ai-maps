...
DISHES_DATA = [
    ...
    },
    {
        ...
        "category": Dish.Category.TORTILLA,
        "price": Decimal("4.50"),
        "description": "Tortilla con bacalao desmenuzado",
    },
    {
    ...
    },
    {
        ...
        "category": Dish.Category.CROQUETAS,
        "price": Decimal("2.50"),
        "description": "Croquetas de setas de temporada",
    },
    {
        "name": "Croquetas de Bacalao",
        "category": Dish.Category.CROQUETAS,
        "price": Decimal("3.00"),
        "description": "Croquetas de bacalao desalado",
    },
    {
        "name": "Calamares a la Romana",
        "category": Dish.Category.CALAMARES,
        "price": Decimal("4.00"),
        "description": "Calamares frescos rebozados",
    },
    {
        "name": "Calamares en su Tinta",
        "category": Dish.Category.CALAMARES,
        "price": Decimal("5.00"),
        "description": "Calamares en tinta de calamar",
    },
    {
        "name": "Taco de Carnitas",
        "category": Dish.Category.COMIDA_MEXICANA,
        "price": Decimal("3.50"),
        "description": "Taco con carnitas desmenuzadas",
    },
    {
        "name": "Quesadilla Vegetal",
        "category": Dish.Category.COMIDA_MEXICANA,
        "price": Decimal("3.00"),
        "description": "Quesadilla con queso fundido y verduras",
    },
    {
        "name": "Patatas Bravas",
        "category": Dish.Category.PATATAS_BRAVAS,
        "price": Decimal("2.50"),
        "description": "Patatas fritas con salsa brava y alioli",
    },
    {
        "name": "Tarta de Queso Horno",
        "category": Dish.Category.TARTA_QUESO_HORNO,
        "price": Decimal("4.00"),
        "description": "Tarta de queso al horno estilo NY",
    },
    {
        "name": "Tarta de Queso Frío",
        "category": Dish.Category.TARTA_QUESO_FRIO,
        "price": Decimal("3.50"),
        "description": "Tarta de queso frío con mermelada",
    },
    {
        "name": "Hamburguesa Txuleta",
        "category": Dish.Category.HAMBURGUESA,
        "price": Decimal("5.50"),
        "description": "Hamburguesa con carne de txuleta vasca",
    },
    {
    ...
    },
    {
        ...
        "category": Dish.Category.PIZZA,
        "price": Decimal("6.00"),
        "description": "Pizza con jamón, tocino y salchicha",
    },
    {
        "name": "Sushi Variado",
        "category": Dish.Category.SUSHI,
        "price": Decimal("5.50"),
        "description": "Surtido de sushi fresco",
    },
    {
        "name": "Sushi Tempura",
        "category": Dish.Category.SUSHI,
        "price": Decimal("6.00"),
        "description": "Sushi tempura con camarones",
    },
]
                ...
                if created:
                    ...
                    for i in range(num_ratings):
                        ...
                        rating_user, _ = User.objects.get_or_create(
                            ...
                            defaults={
                                "email": f"user_{restaurant.id}_{dish.id}_{i}@pintxos.eus"
                            },
                        )
