...
from .models import Dish, DishFavorite, DishRating, Restaurant, RestaurantClaim
...
class RestaurantAdmin(GISModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("name", "description", "category", "approved")}),
        ("Location", {"fields": ("location", "address")}),
        ("Contact & Info", {"fields": ("phone", "website", "image_url", "hours")}),
        (
            "Ownership",
            {
                "fields": ("claimed_by",),
