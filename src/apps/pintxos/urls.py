...
urlpatterns = [
    ...
    path('restaurant/<int:restaurant_id>/claim/', views.restaurant_claim, name='restaurant_claim'),
    path('restaurant/<int:restaurant_id>/manage/', views.restaurant_manage, name='restaurant_manage'),
