    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relevance', models.CharField(choices=[
                    ('EUSKADI', 'Euskadi'),
                    ('ESPANA', 'España'),
                    ('GLOBAL', 'Global'),
                ], db_index=True, default='GLOBAL', max_length=8)),
                ('tags', models.JSONField(blank=True, default=list)),
                ('affects_user_plan', models.BooleanField(db_index=True, default=False)),
                ('embedding', pgvector.django.VectorField(blank=True, dimensions=768, null=True)),
            ],
            options={
                'ordering': ['-published_at'],
                'indexes': [
                    models.Index(fields=['-published_at', 'relevance'], name='mubil_newsa_publish_rel_idx'),
                ],
            },
        ),
