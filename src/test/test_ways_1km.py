...
start_node = find_nearest_node_ways(-1.9812, 43.3183) # Donostia center
end_node = find_nearest_node_ways(-1.9812, 43.3100) # Donostia ~1km away
...
if start_node and end_node:
    ...
    with connection.cursor() as cursor:
        ...
        print("Dijkstra 1km result count:", len(rows))
        if rows:
            print("Path steps:", rows[:5])
