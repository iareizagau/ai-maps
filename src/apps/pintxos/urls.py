...
urlpatterns = [
    ...
    path(
        "comanda/manifest.webmanifest", views.comanda_manifest, name="comanda_manifest"
    ),
    ...
    path(
        "restaurant/<int:restaurant_id>/claim/",
        views.restaurant_claim,
        name="restaurant_claim",
    ),
    path(
        "restaurant/<int:restaurant_id>/manage/",
